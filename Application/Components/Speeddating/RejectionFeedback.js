...
var data = {};
class RejectionFeedback extends BaseFormComponent {
    constructor(props) {
        super(props);
        this.state = {
            questionData: [],
    ...
    componentDidMount = () => {
        ...
        Apirequest.getFeedbackQuestions(token, 'speeddatingInvitationRejectionFeedback', resolve => {
...
export default connect(mapStateToProps)(RejectionFeedback);