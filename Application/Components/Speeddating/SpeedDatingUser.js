...
export default class SpeedDatingUser extends Component {
    ...
    renderRow = (item) => {
        return <TouchableOpacity
            disabled={item.isHighlight ? false : true}
            style={{
            ...
            }} onPress={() => this.props.navigate('speeddatinglivecall', { userId : item.userId})}>
            ...
            <View style={{ flex: 8, backgroundColor: "transparent", justifyContent: "center", justifyContent: "center", paddingHorizontal: 15 }}>
                ...
                {
                   item.isHighlight ? <Animated.Image style={{ width: 40, height: 25, transform: [{ scale: this.springValue }] }}
