...
import { Platform,Image,StyleSheet,StatusBar,Text,TouchableHighlight,PanResponder,View, Dimensions } from 'react-native';
const Util = {
    size: {
...
class MoveableCircle extends Component{
  ...
  _circleStyles = {};
  circle = (setNativeProps({props: Object}) );
  ...
  render() {
    return(
      ...
      <View style={{ width:50, height:50, backgroundColor:"#009933" }}/>
      </View>
    )
  }
}

export default class animationUserProfile extends Component{
  componentWillMount() {
    if(Platform.OS === "ios"){
