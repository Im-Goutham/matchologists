    ...
    render() {
        ...
        return (
            <LinearGradient
                ...
                <View style={{ height: IS_ANDROID ? 66 : 81, justifyContent: IS_ANDROID ? "center" : "flex-end", backgroundColor: "transparent" }}>
                    <View style={{ height: 66, flexDirection: "row", alignContent: IS_ANDROID ? "center" : "flex-end", backgroundColor: "transparent" }}>
                        {this.props.left}
                        {this.props.middle}
                        {this.props.right}
                    </View>
