...
export default class FeedbackInbox extends Component {
    constructor(props) {
        super(props);
        this.state = {
            visibleModal: false,
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                        ...
                        isSearcrchbar={false}
                            ...
                            middle={
                                <View style={{ width: "70%", backgroundColor: "transparent", alignItems: "center", justifyContent: "center" }}>
                                    <Text style={{ fontFamily: "Avenir-Heavy", fontSize: 24, color: "#fff" }}> FeedBack Inbox</Text>
                                </View>
                            }
                            right={
                                <TouchableOpacity 
                ...
                <FeedbackList navigation={this.props.navigation} />
